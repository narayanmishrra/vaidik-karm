...
• Message: ${formData.message || 'Seeking guidance on Mahurat and Vidhi details.'}`;
  ...
  const formLabels = {
    ...
    addressText: lang === 'hi' ? 'त्र्यंबकेश्वर गाँव, नासिक जिला, महाराष्ट्र 422212, भारत' : 'Trimbakeshwar Village, Nashik District, Maharashtra 422212, India',
    mapTitle: lang === 'hi' ? '📍 त्र्यंबकेश्वर मंदिर क्षेत्र मानचित्र' : '📍 Trimbakeshwar Temple Vicinity Map',
    interactiveLocation: lang === 'hi' ? 'इंटरैक्टिव स्थान' : 'Interactive Location',
    purohitOffice: lang === 'hi' ? 'पुरोहित कार्यालय' : 'Purohit Office',
    distanceFromKund: lang === 'hi' ? 'कुशावर्त कुंड एवं मुख्य मंदिर प्रवेश द्वार से 1000 मीटर' : '1000 meters from Kusavarta Kund & Main Temple Entrance',
